...
$job_expirience = [
    ...
    'time-of_work' => ['Jan 2015','Mar 2012 - Dec 2014','Jun 2010 - Mar 2012'],
    'description' => ['Development sites organosation','Creation WEB sites.', 'Designe sites']
];
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
         ...
         <?php for($i=0; $i<3; $i++) {?> 
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $job_expirience['position'][$i] ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job_expirience['time-of_work'][$i] ?> 
                <?php if ($i == 0) {?> <span class="w3-tag w3-teal w3-round">Current</span></h6> <?php } ?>
            <p><?php echo $job_expirience['description'][$i] ?></p>
            <hr>
          </div>
         <?php } ?>
